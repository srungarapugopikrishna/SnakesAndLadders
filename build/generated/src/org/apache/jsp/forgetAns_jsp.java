...
public final class forgetAns_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Connection con=null;
      ...
      out.write("\t<form name=\"myForm\"   action=\"LogIn.html\" method=post >\t<pre><font size=\"4\" color=\"orange\"><br>\n");
      out.write("\t\t\t  ");
    ...
    if(rs.next()){
      out.write(" <b>Your Password: ");
      out.print(rs.getString(1) );
}else{
      out.write("Sorry!!!!! Answer doesn't matched...");
}
      out.write("</b><br><br>\n");
      out.write("\t\t\t</b><br><br>\n");
